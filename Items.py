...
item_table: Dict[str, TItemData] = {
	...
	"Next Stage":					TItemData("[Global] Stages", STARTING_ID + 201, ItemClassification.progression_skip_balancing, 6),
	"[Reimu] Next Stage":			TItemData("[Character] Stages", STARTING_ID + 202, ItemClassification.progression_skip_balancing, 6),
	"[Marisa] Next Stage":			TItemData("[Character] Stages", STARTING_ID + 203, ItemClassification.progression_skip_balancing, 6),
	"[Sakuya] Next Stage":			TItemData("[Character] Stages", STARTING_ID + 204, ItemClassification.progression_skip_balancing, 6),
	"[Reimu A] Next Stage":			TItemData("[Shot Type] Stages", STARTING_ID + 205, ItemClassification.progression_skip_balancing, 6),
	"[Reimu B] Next Stage":			TItemData("[Shot Type] Stages", STARTING_ID + 206, ItemClassification.progression_skip_balancing, 6),
	"[Marisa A] Next Stage":		TItemData("[Shot Type] Stages", STARTING_ID + 207, ItemClassification.progression_skip_balancing, 6),
	"[Marisa B] Next Stage":		TItemData("[Shot Type] Stages", STARTING_ID + 208, ItemClassification.progression_skip_balancing, 6),
	"[Sakuya A] Next Stage":		TItemData("[Shot Type] Stages", STARTING_ID + 209, ItemClassification.progression_skip_balancing, 6),
	"[Sakuya B] Next Stage":		TItemData("[Shot Type] Stages", STARTING_ID + 210, ItemClassification.progression_skip_balancing, 6),
